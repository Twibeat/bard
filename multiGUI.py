...
"}"))
        ...
        self.tabWidget.setGeometry(QtCore.QRect(10, 10, 981, 401))
        ...
        self.generate_pushButton = QtGui.QPushButton(self.horizontalLayoutWidget_3)
        ...
        self.progressBar.setGeometry(QtCore.QRect(10, 110, 401, 31))
        ...
        self.multi_input_lineEdit = QtGui.QLineEdit(self.horizontalLayoutWidget_4)
        self.multi_input_lineEdit.setObjectName(_fromUtf8("multi_input_lineEdit"))
        self.horizontalLayout_1.addWidget(self.multi_input_lineEdit)
        self.multi_input_pushButton = QtGui.QPushButton(self.horizontalLayoutWidget_4)
        self.multi_input_pushButton.setObjectName(_fromUtf8("multi_input_pushButton"))
        self.horizontalLayout_1.addWidget(self.multi_input_pushButton)
        ...
        self.multi_output_lineEdit_2 = QtGui.QLineEdit(self.horizontalLayoutWidget_5)
        self.multi_output_lineEdit_2.setObjectName(_fromUtf8("multi_output_lineEdit_2"))
        self.horizontalLayout_4.addWidget(self.multi_output_lineEdit_2)
        self.multi_output_pushButton = QtGui.QPushButton(self.horizontalLayoutWidget_5)
        self.multi_output_pushButton.setObjectName(_fromUtf8("multi_output_pushButton"))
        self.horizontalLayout_4.addWidget(self.multi_output_pushButton)
        ...
        self.multi_generate_pushButton = QtGui.QPushButton(self.horizontalLayoutWidget_6)
        self.multi_generate_pushButton.setObjectName(_fromUtf8("multi_generate_pushButton"))
        self.horizontalLayout_5.addWidget(self.multi_generate_pushButton)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.input_label.setText(_translate("Dialog", "입력 파일 ", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Dialog", "InstantMode", None))
        self.input_label_2.setText(_translate("Dialog", "입력 경로 ", None))
        self.multi_input_pushButton.setText(_translate("Dialog", "찾아보기", None))
        self.output_label_2.setText(_translate("Dialog", "출력 경로 ", None))
        self.multi_output_pushButton.setText(_translate("Dialog", "찾아보기", None))
        self.label_2.setText(_translate("Dialog", "입력 파일과 출력 경로 설정 후 생성버튼을 눌러주세요", None))
        self.multi_generate_pushButton.setText(_translate("Dialog", "생성", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("Dialog", "Mode2", None))
