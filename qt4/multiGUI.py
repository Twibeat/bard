...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("../../Users/spear/Desktop/candy.PNG")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}"))
        ...
        self.horizontalLayoutWidget_13 = QtGui.QWidget(self.tab_5)
        ...
        self.output_label_6 = QtGui.QLabel(self.horizontalLayoutWidget_13)
        self.output_label_6.setObjectName(_fromUtf8("output_label_6"))
        self.horizontalLayout_12.addWidget(self.output_label_6)
        self.generation_sample_lineEdit = QtGui.QLineEdit(self.horizontalLayoutWidget_13)
        self.generation_sample_lineEdit.setObjectName(_fromUtf8("generation_sample_lineEdit"))
        self.horizontalLayout_12.addWidget(self.generation_sample_lineEdit)
        self.generate_sample_pushButton = QtGui.QPushButton(self.horizontalLayoutWidget_13)
        self.generate_sample_pushButton.setObjectName(_fromUtf8("generate_sample_pushButton"))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.output_label_6.setText(_translate("Dialog", "    샘플 파일 ", None))
        self.generate_sample_pushButton.setText(_translate("Dialog", "찾아보기", None))
